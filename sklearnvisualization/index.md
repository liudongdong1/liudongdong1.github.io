...
![Learning Curves (Naive Bayes), Learning Curves (SVM, RBF kernel, $\gamma=0.001$), Scalability of the model, Scalability of the model, Performance of the model, Performance of the model](https://scikit-learn.org/stable/_images/sphx_glr_plot_learning_curve_001.png)
